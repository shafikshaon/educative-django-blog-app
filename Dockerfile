...
COPY educative_django_blog  /usr/local/educative/educative_django_blog
...
WORKDIR /usr/local/educative/educative_django_blog

RUN pwd
RUN ls
RUN python3 manage.py makemigrations
RUN python3 manage.py migrate
RUN python3 manage.py generate_blogs
